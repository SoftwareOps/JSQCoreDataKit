...
final class ContextSyncTests: TestCase {
    ...
    func test_ThatChangesPropagate_FromMainContext_ToBackgroundContext() {
        ...
        expectation(forNotification: NSNotification.Name(rawValue: Notification.Name.NSManagedObjectContextDidSave.rawValue), object: inMemoryStack.mainContext, handler: nil)
    ...
    func test_ThatChangesPropagate_FromBackgroundContext_ToMainContext() {
        ...
        expectation(forNotification: NSNotification.Name(rawValue: Notification.Name.NSManagedObjectContextDidSave.rawValue), object: inMemoryStack.backgroundContext, handler: nil)
    ...
    func test_ThatChangesPropagate_FromChildContext_ToMainContext() {
        ...
        expectation(forNotification: NSNotification.Name(rawValue: Notification.Name.NSManagedObjectContextDidSave.rawValue), object: childContext, handler: nil)
