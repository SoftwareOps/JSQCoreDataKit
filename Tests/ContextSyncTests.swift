...
final class ContextSyncTests: TestCase {
    ...
    func test_ThatChangesPropagate_FromMainContext_ToBackgroundContext() {
        ...
        expectation(forNotification: convertToNSNotificationName(Notification.Name.NSManagedObjectContextDidSave.rawValue), object: inMemoryStack.mainContext, handler: nil)
    ...
    func test_ThatChangesPropagate_FromBackgroundContext_ToMainContext() {
        ...
        expectation(forNotification: convertToNSNotificationName(Notification.Name.NSManagedObjectContextDidSave.rawValue), object: inMemoryStack.backgroundContext, handler: nil)
    ...
    func test_ThatChangesPropagate_FromChildContext_ToMainContext() {
        ...
        expectation(forNotification: convertToNSNotificationName(Notification.Name.NSManagedObjectContextDidSave.rawValue), object: childContext, handler: nil)
...
fileprivate func convertToNSNotificationName(_ input: String) -> NSNotification.Name {
	return NSNotification.Name(rawValue: input)
}
